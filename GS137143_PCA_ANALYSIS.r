...
# ============================================================
# Extract Group (MS/HC) and CellType (CD4/CD8/CD14) from these
...
# Metadata rows must match count matrix columns
...
# They must be removed before the dbatch effect assessment
